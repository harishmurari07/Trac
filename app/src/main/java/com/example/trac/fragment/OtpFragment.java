...
public class OtpFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        otpFragmentBinding.submit.setOnClickListener(v -> {
            ...
            loginViewModel.validateNewUser(new ValidateOtpRequest("vasanth4.demo@gmail.com", "9884991818", "136943", "MTM2OTQz"));
            subscribeForResult();
        });
    ...
    private void subscribeForResult() {
        loginViewModel.getOtpSuccess().observe(this, new Observer<OtpResponse>() {
            @Override
